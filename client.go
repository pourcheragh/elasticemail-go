...
// APIClient manages communication with the Elastic Email REST API API v4.0.0
...
type APIClient struct {
	...
	InboundRouteAPI *InboundRouteAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.InboundRouteAPI = (*InboundRouteAPIService)(&c.common)
